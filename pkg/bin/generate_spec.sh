...
%changelog
* $(date +"%a %b %d %Y") $MAINTAINER - $RECIPE_VERSION-$RECIPE_RELEASE. Autogenerated from CI, please see github.com/ilya-zlobintsev/LACT/releases for detailed changelog.
${EXISTING_CHANGELOG}
EOF
